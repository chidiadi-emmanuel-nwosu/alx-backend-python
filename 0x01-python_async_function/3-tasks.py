...
def task_wait_random(max_delay: int) -> asyncio.Task:
    """
    Creates an asyncio.Task for the wait_random coroutine with a specified maximum delay.

    Args:
    - max_delay (int): The maximum delay value for wait_random.

    Returns:
    - asyncio.Task: An asyncio.Task representing the concurrent execution of wait_random
